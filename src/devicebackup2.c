...
LIBIMOBILEDEVICE_API int run_cmd(int cmd, int cmd_flags, char* udid, char* source_udid, char* backup_directory, int interactive_mode, char* backup_password, char* newpw)
{
